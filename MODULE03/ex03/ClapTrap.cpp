...
{
    std::cout << "Booommmm (%#*) !!!!";
    std::cout << " You loose " << amount << " _hit point" << std::endl;
    _hit -= amount;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        _energy--;
        std::cout << "Gooodddd!!!  You got " << amount << " _energy" << std::endl;
        _hit += amount;
    }
     else
    {
        std::cout << "Sorry, You have not enougth _energy to be repaired" << std::endl;
    }
}
